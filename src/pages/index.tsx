...
function HomePage() {
  return (
    <>
      <Head>
        <title>RestoMax</title>

        <meta
          name="description"
          content="Empower Your Restaurant with RestoMax: Streamline Orders, Optimize Inventory, Schedule Staff, and Deliver an Unforgettable Dining Experience for Your Customers."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Empower Your Restaurant with RestoMax: Streamline Orders, Optimize Inventory, Schedule Staff, and Deliver an Unforgettable Dining Experience for Your Customers.`}
            </Text>
